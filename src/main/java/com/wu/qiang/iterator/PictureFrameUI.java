...
/**
 * 相框类,UI层，具体使用迭代器的地方，是按钮的地方
 * @auth wq on 2019/12/11 17:12
 **/
public class PictureFrameUI extends JFrame implements ActionListener {
    ViewSpotSet ag; //婺源景点集接口
    ViewSpotIterator it; //婺源景点迭代器接口
    WyViewSpot ob;    //婺源景点类

    public PictureFrameUI() {
    ...
    private void showPicture(String name, String introduce) {
        ...
        String fileName="src/main/resources/iterator/Picture/"+name+".jpg";
